    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                className="block w-full bg-gray-50 border border-gray-300 text-gray-700 py-2 pl-10 pr-3 rounded-xl leading-tight focus:outline-none focus:border-indigo-500"
                value={searchTerm}
