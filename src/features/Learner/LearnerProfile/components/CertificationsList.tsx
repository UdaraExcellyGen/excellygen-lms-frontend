      ...
      <div className="grid gap-3 md:gap-4">
        {completedCertifications.length === 0 ? (
          ...
          completedCertifications.map((cert) => (
            <div key={cert.name} className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 bg-[#F6E6FF] rounded-lg transform transition-transform hover:scale-102">
