...
// //         // DEBUGGING: Check the data from your API
// //         console.log("Received Attempt Details:", details);
...
// //   const scorePercentage = attemptDetails.totalQuestions > 0
...
// //               <div className="absolute inset-0 rounded-full bg-[#1B0A3F]" />
// //               <svg className="w-full h-full absolute top-0 left-0 transform -rotate-90" viewBox="0 0 100 100">
// //                 <circle cx="50" cy="50" r="44" stroke="rgba(255,255,255,0.1)" strokeWidth="8" fill="transparent" />
// //                 <circle
// //                   cx="50" cy="50" r="44"
// //                   stroke={isPassing ? "url(#gradient-green)" : "url(#gradient-yellow)"}
...
// //                 />
// //                 <defs>
// //                   <linearGradient id="gradient-green"><stop offset="0%" stopColor="#22c55e" /><stop offset="100%" stopColor="#14b8a6" /></linearGradient>
// //                   <linearGradient id="gradient-yellow"><stop offset="0%" stopColor="#f59e0b" /><stop offset="100%" stopColor="#fbbf24" /></linearGradient>
// //                 </defs>
// //               </svg>
// //               <div className="text-center z-10">
// //                 <div className={`text-6xl font-bold ${isPassing ? 'text-green-400' : 'text-yellow-400'} drop-shadow-md`}>
// //                   {animatedScore}%
// //                 </div>
// //                 <div className="text-white/80 text-base mt-1">
// //                   {attemptDetails.correctAnswers} / {attemptDetails.totalQuestions}
// //                 </div>
// //                 <div className={`mt-2 inline-block px-4 py-1 rounded-full text-sm font-medium ${isPassing ? 'bg-green-500/20 text-green-300' : 'bg-yellow-500/20 text-yellow-300'}`}>
// //                   {isPassing ? 'PASSED' : 'FAILED'}
// //                 </div>
// //               </div>
// //             </div>
...
// //                     : "This was a good first attempt. Review the answers below to strengthen your understanding, and feel free to try again."
// //                   }
// //                 </p>
// //             </div>
// //           </div>
...
//       // Pass a 'refresh: true' state to signal the course overview page to refetch data.
//       navigate(`/learner/course-view/${targetCourseId}`, {
//         replace: true,
//        state: { 
//           quizCompleted: true, 
...
//         }
//         //state: { refresh: true, from: 'quiz-results' } // Added state
//       });
//     } else {
//       navigate('/learner/dashboard');
//     }
...
//                {/*
//                 * [NECESSARY FIX]
//                 * The message for a failed quiz has been updated to remove the suggestion
//                 * of retaking the quiz, aligning with the "one attempt only" rule.
//                 */}
//                <p className="text-white/80 text-sm">
//                   {isPassing 
//                     ? "Excellent work! You have a solid grasp of the material. Keep up the great momentum!"
//                     : "This was your attempt. Review the answers below to strengthen your understanding of the material."
//                   }
//                 </p>
//             </div>
//           </div>
...
const QuizResults: React.FC = () => {
  ...
  const handleBackToCourse = () => {
    ...
    if (targetCourseId && attemptDetails) {
      // Send all necessary info back to the overview page to manually update its state.
      navigate(`/learner/course-view/${targetCourseId}`, {
        replace: true,
        state: { 
          quizCompleted: true, 
  ...
  if (isLoading) { return <div className="min-h-screen bg-gradient-to-b from-[#52007C] to-[#34137C] p-6 flex justify-center items-center">Loading...</div>; }
  if (!attemptDetails) { return <div className="min-h-screen bg-gradient-to-b from-[#52007C] to-[#34137C] p-6 flex justify-center items-center">Unable to load results.</div>; }
