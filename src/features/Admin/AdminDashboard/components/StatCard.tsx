...
const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-6 transition-all duration-300 hover:shadow-md">
      ...
      <button 
        onClick={onViewMore}
        className="w-full py-3 px-6 bg-gradient-to-r from-[#BF4BF6] to-[#7A00B8] text-white rounded-lg hover:scale-105 hover:from-[#D68BF9] hover:to-[#BF4BF6] transition-all duration-300 font-nunito shadow-lg active:scale-95 inline-flex items-center justify-center gap-2"
      >
        <span>View More</span>
