...
import PMNotificationGroup from './Components/PMnotificationGroup';
import { 
  NotificationsState 
} from './types/PMnotification';
import { mockNotifications } from './data/mockData';

const ProjectManagerNotification: React.FC = () => {
      ...
      <div className="max-w-7xl mx-auto px-8 space-y-8">
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-[#D68BF9] mt-1">Stay updated with project acceptances</p>
          </div>
        </div>
...
export default ProjectManagerNotification;